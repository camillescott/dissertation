...
**I. Portability:** Analyses written in workflow languages (with integrated software management) can be run across computing systems without changes to code.](figure/workflows/workflow_figure.pdf){#fig:workflow}
...
](figure/workflows/conda_figure_ABC.pdf){#fig:conda_figure_ABC height=7in}
