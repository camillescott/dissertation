...
Workflow systems contain powerful infrastructure for workflow management that can coordinate runtime behavior, self-monitor progress and resource usage, and compile reports documenting the results of a workflow (**Figure \@ref(fig:fig-workflows-workflow)**).
...
<!-- BEGIN workflow figure -->

```{r fig-workflows-workflow, results="asis", echo=FALSE, fig.cap="(ref:fig-workflows-workflow)", out.width="90%", fig.align="center"}
include_graphics("figure/workflows/workflow_figure.pdf")
```

(ref:fig-workflows-workflow) **Workflow Systems:** Bioinformatic workflow systems have built-in functionality that facilitates and simplifies running analysis pipelines.
...
First, workflows become minimally self-documented, as the directed graph produced by workflow systems can be exported and visualized, producing a graphical representation of the relationships between all steps in a pipeline (see **Figure @ref:fig-rnaseq_workflow**).
...
```{r fig-workflows-conda, results="asis", echo=FALSE, fig.cap="(ref:fig-workflows-conda)", fig.align="center", out.height="3in"}
include_graphics("figure/workflows/conda_figure.pdf")
```

(ref:fig-workflows-conda) **The conda package and environment manager simplifies software installation and management.**
...
<!-- BEGIN notebooks figure -->

```{r fig-workflows-notebooks, results="asis", echo=FALSE, fig.cap="(ref:fig-workflows-notebooks)", out.width="100%"}
include_graphics("figure/workflows/nb_figure.pdf")
```

(ref:fig-workflows-notebooks) **Examples of computational notebooks.** Computational notebooks allow the user to mix text, code, and results in one document.
...
For a larger analysis DAG, see [@doi:10.1186/s13059-020-02066-4]](figure/workflows/rnaseq_dag.png){#fig:rnaseq_workflow height=3in}
...
](figure/workflows/interactive_viz.png){#fig:interactiveviz}
...
](figure/workflows/checksum_file.pdf){#fig:checksum height=2.5in}
...
](figure/workflows/multiqc_viz.pdf){#fig:multiqc}
