...
**I. Portability:** Analyses written in workflow languages (with integrated software management) can be run across computing systems without changes to code.](figure/workflows/workflow_figure.svg){#fig:workflow}
...
](figure/workflows/conda_figure_ABC.svg){#fig:conda_figure_ABC height=7in}
...
](figure/workflows/nb_figure.png){#fig:nb_figure}
...
](figure/workflows/checksum_file.svg){#fig:checksum height=2.5in}
...
](figure/workflows/multiqc_viz.svg){#fig:multiqc}
