...
# Appendix: The `goetia` Library and Software
...
The expected  partitioning method for $k$-mers are minimizer methods, particularly the Universal $k$-mer Hitting Set (UHS), which is implemented in the `hashing` namespace and described in the streaming sketch chapter.
...
`TraverState` can have the following values:
