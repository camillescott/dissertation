...
Large-scale genome sequencing is one of the most paradigm-shifting technologies for biology of the 21st century.
Since the sequencing of the human genome was declared complete in April of 2003, genomics has been a core part of the public
conscience and rapidly grown as a tool for biological research.
...
The reasons are twofold: firstly, because genomic dBGs tend to consist of many linear paths of $k$-mers with in and out-degree of $1$, such graphs encode a lot of redundant information; secondly, because $k$-mers are exact substrings over a sliding window on the input sequences, each error or point mutation in the input sequences introduces $k$ new nodes in the graph.
