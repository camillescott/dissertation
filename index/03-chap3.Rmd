...
This library provides parsing support for GFF3, HMMER and Infernal tabular output, MAF, and TransDecoder FASTA, returning the parsed data in `pandas` DataFrames [@mckinney_data_2010] for use within the Python data science ecosystem.
