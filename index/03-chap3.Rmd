...
The project eventually lead to a publication making use of version of the resulting transcripts and annotations [@doi:doi.org/10.1186/s12864-015-1677-z], though a publication concerning the re-assembly itself was abandoned.
...
OrthoDB v8 and optionally uniref90 are searched using LAST [@sheetlin_frameshift_2014,@kielbasa_adaptive_2011]
If the user supplies any custom protein databases, they are searched for orthologs using Conditional Reciprocal Best Hits [@aubry_deep_2014].
