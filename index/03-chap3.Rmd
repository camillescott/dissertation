...
Version 2 is a complete rewrite using Snakemake [@doi:https://doi.org/10.12688/f1000research.29032.1]; while the underlying pipeline remains mostly the same, the `pydoit` tasks have been converted into reusable Snakemake wrappers and the command line interface (CLI) wraps the Snakemake CLI.
...
This library provides parsing support for GFF3, HMMER and Infernal tabular output, MAF, and TransDecoder FASTA, returning the parsed data in `pandas` DataFrames [@doi:10.5281/zenodo.3509134; @doi:10.25080/Majora-92bf1922-00a] for use within the Python data science ecosystem.
