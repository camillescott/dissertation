...
TwoPaCo generates the cDBG from a collection of previously assembled genomes using a two-pass Bloom-filter approach to eliminate candidate decision (CTB: explain why yo uwant to eliminate candidate decision k-mers?) $k$-mers [@doi:10.1093/bioinformatics/btw609].
