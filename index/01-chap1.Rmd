...
res <- knitr::knit_child('chap1-findsegments-alg.Rmd', quiet=TRUE)
cat(res, sep='\n')
```
...
Iterative construction of the cDBG intuitively enables iterative analysis of the graph.



### Compaction can be included in Low Overhead Pipelines
